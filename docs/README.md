...
This directory contains the Jekyll documentation site for Apathetic Python Testing, designed to be deployed to GitHub Pages.
...
3. Open your browser to `http://localhost:4000/python-testing/`

   Note: The baseurl is `/python-testing`, so make sure to include it in the local URL.
...
- `https://apathetic-tools.github.io/python-testing/`
...
- `baseurl`: Set to `/python-testing` (matches the repository name)

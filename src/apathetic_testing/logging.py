"""Logging helpers for isolated logging in tests.
...
class _apathetic_testing_priv_LoggingIsolation:  # noqa: N801
    ...
    def capture_streams(self) -> _apathetic_testing_priv_StreamCapture:
        ...
        Example:
            def test_no_duplication(isolated_logging):
                with isolated_logging.capture_streams() as capture:
                    ...
                    assert count == 1
        """
        return _apathetic_testing_priv_StreamCapture()


class _apathetic_testing_priv_LoggingTestLevel:  # noqa: N801
    ...
    def __init__(
        self,
        isolation: _apathetic_testing_priv_LoggingIsolation,
        ...
        apathetic_logging.setRootLevel("TEST")
    ...
    def _install_prevention(self) -> None:
        ...
        def protectedSetRootLevel(level: str | int, **kwargs: Any) -> None:  # noqa: N802
...
class _apathetic_testing_priv_LoggingLevelTesting:  # noqa: N801
    ...
    def _install_tracking(self) -> None:
        ...
        def trackedSetRootLevel(level: str | int, **kwargs: Any) -> None:  # noqa: N802
...
@pytest.fixture
def isolated_logging() -> Generator[
    _apathetic_testing_priv_LoggingIsolation, None, None
]:
    ...
    isolation = _apathetic_testing_priv_LoggingIsolation(saved_state)
    yield isolation
...
def logging_test_level(
    isolated_logging: _apathetic_testing_priv_LoggingIsolation,
    monkeypatch: pytest.MonkeyPatch,
) -> _apathetic_testing_priv_LoggingTestLevel:
    ...
    """
    return _apathetic_testing_priv_LoggingTestLevel(isolated_logging, monkeypatch)
...
def logging_level_testing(
    ...
    monkeypatch: pytest.MonkeyPatch,
) -> _apathetic_testing_priv_LoggingLevelTesting:
    ...
    return _apathetic_testing_priv_LoggingLevelTesting(
        isolated_logging,
...
class _apathetic_testing_priv_LogRecordCapture(  # noqa: N801
    logging.Handler
):
...
class _apathetic_testing_priv_StreamCapture:  # noqa: N801
    ...
    def __init__(self) -> None:
        self._capture_handler = _apathetic_testing_priv_LogRecordCapture()

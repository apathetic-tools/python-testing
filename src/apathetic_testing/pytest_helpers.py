...
class LoggingIsolation:
    ...
    def capture_streams(self) -> StreamCapture:
...
def logging_test_level(
    ...
    """
    return LoggingTestLevel(isolated_logging, monkeypatch)
...
def logging_level_testing(
    ...
    return LoggingLevelTesting(isolated_logging, initial_level, monkeypatch)  # pyright: ignore[reportUnknownArgumentType]
